...
public abstract class DefaultEbicsRootElement implements EbicsRootElement {
	...
	public DefaultEbicsRootElement(EbicsSession session) {
		...
		suggestedPrefixes.put("urn:org:ebics:H005", "");
		suggestedPrefixes.put("urn:org:ebics:H004", "");
		suggestedPrefixes.put("http://www.ebics.org/H003", "");
		suggestedPrefixes.put("http://www.ebics.org/S002", "");
