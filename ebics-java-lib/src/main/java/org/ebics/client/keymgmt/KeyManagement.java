...
public abstract class KeyManagement {
     ...
     */
    public abstract String sendINI(String orderId) throws EbicsException, IOException;
     ...
     * @throws EbicsException server generated error message
     */
    public abstract String sendHIA(String orderId) throws IOException, EbicsException;
     ...
     * @throws EbicsException server generated error message
     */
    public abstract String sendHPB() throws IOException, GeneralSecurityException, EbicsException;
     ...
     */
    public abstract String lockAccess() throws IOException, EbicsException;
