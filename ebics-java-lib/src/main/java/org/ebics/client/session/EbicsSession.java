...
public class EbicsSession {
	...
	/**
	 * Returns the banks encryption key. The key will be fetched automatically form
	 * the bank if needed.
	 * 
	...
	/**
	 * Returns the banks authentication key. The key will be fetched automatically
	 * form the bank if needed.
	 * 
	...
	/**
	 * Sets the optional product identification that will be sent to the bank during
	 * each request.
	 * 
